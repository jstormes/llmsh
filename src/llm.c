...
static const char *SYSTEM_PROMPT =
    ...
    "- When accessing files, ALWAYS start with 'ls' to see the actual directory "
    "contents. Use the paths returned by ls, not guesses. Source code is often "
    "in subdirectories like src/, lib/, include/. Check before assuming paths.\n"
    "- If a file read fails, try listing the directory to find the correct path.\n\n"
    "Man page support:\n"
